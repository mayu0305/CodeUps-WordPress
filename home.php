...
<main class="main">
    ...
    <?php
    // カスタム投稿タイプが"custom_post_type"のクエリを取得
    $args = array(
        'post_type' => 'blog',
        'posts_per_page' => 10, // 1ページに表示する投稿数
        'paged' => get_query_var('paged') ? get_query_var('paged') : 1, // 現在のページ数を取得
    );
    $query = new WP_Query($args);

    // クエリが投稿を持っている場合はループを開始
    if ($query->have_posts()) :
            ...
            <div class="blog-content__body">
                <div class="blog-content__main">
                    <article class="blog-content__main-items blog-cards blog-cards--page">
                        <a href="single.html" class="blog-card blog-cards__item">
                            ...
                            <figure class="blog-card__img">
                                <img src="assets/images/blog/blog-post01.webp" alt="サンゴの写真" decoding="async" loading="lazy">
                            </figure>
                        </a><!-- blog-card -->
                        <a href="single.html" class="blog-card blog-cards__item">
                            <div class="blog-card__content">
                            ...
                            <figure class="blog-card__img">
                                <img src="assets/images/blog/blog-post02.webp" alt="ウミガメの写真" decoding="async" loading="lazy">
                            </figure>
                        </a><!-- blog-card -->
                        <a href="single.html" class="blog-card blog-cards__item">
                            <div class="blog-card__content">
                            ...
                            <figure class="blog-card__img">
                                <img src="assets/images/blog/blog-post03.webp" alt="カクレクマノミの写真" decoding="async" loading="lazy">
                            </figure>
                        </a><!-- blog-card -->
                        <a href="single.html" class="blog-card blog-cards__item">
                            <div class="blog-card__content">
                            ...
                            <figure class="blog-card__img">
                                <img src="assets/images/blog/blog-post04.webp" alt="熱帯魚の写真" decoding="async" loading="lazy">
                            </figure>
                        </a><!-- blog-card -->
                        <a href="single.html" class="blog-card blog-cards__item">
                            <div class="blog-card__content">
                            ...
                            <figure class="blog-card__img">
                                <img src="assets/images/blog/blog-post05.webp" alt="ウミウシの写真" decoding="async" loading="lazy">
                            </figure>
                        </a><!-- blog-card -->
                        <a href="single.html" class="blog-card blog-cards__item">
                            <div class="blog-card__content">
                            ...
                            <figure class="blog-card__img">
                                <img src="assets/images/blog/blog-post06.webp" alt="クラゲの写真" decoding="async" loading="lazy">
                            </figure>
                        </a><!-- blog-card -->
                        <a href="single.html" class="blog-card blog-cards__item">
                            <div class="blog-card__content">
                        ...
                        <a href="" class="blog-card blog-cards__item">
                            <div class="blog-card__content">
                                <time class="blog-card__content-date" datetime="2023-11-17">
                                2023.11/17
                                </time>
                ...
                <aside class="aside blog-content__side">
                    <div class="aside__content aside-article">
                        ...
                        <div class="aside-article__items">
                            <a href="" class="aside-article__item">
                                <div class="aside-article__item-text">
                                    <time class="aside-article__item-date" datetime="2023-11-17">2023.11/17</time>
                                    <h3 class="aside-article__item-title">ライセンス取得</h3>
                                </div>
                            ...
                            <a href="" class="aside-article__item">
                                <div class="aside-article__item-text">
                                    <time class="aside-article__item-date" datetime="2023-11-17">2023.11/17</time>
                                    <h3 class="aside-article__item-title">ウミガメと泳ぐ</h3>
                                </div>
                                <figure class="aside-article__item-img">
                                    <img src="assets/images/blog/blog-post02.webp" alt="ウミガメの写真" decoding="async" loading="lazy">
                                </figure>
                            ...
                            <a href="" class="aside-article__item">
                                <div class="aside-article__item-text">
                                    <time class="aside-article__item-date" datetime="2023-11-17">2023.11/17</time>
                                    <h3 class="aside-article__item-title">カクレクマノミ</h3>
                                </div>
                                <figure class="aside-article__item-img">
                                    <img src="assets/images/blog/blog-post03.webp" alt="カクレクマノミの写真" decoding="async" loading="lazy">
                                </figure>
